...
<div class="import-box">
  <div class="each-input1"> <span class="name">邮箱：</span>
    <div class="other">
      <input type="text" class="input">
    </div>
    <div class="error-info">填写报错信息</div>
  </div>
  <div class="each-input1"> <span class="name">验证码：</span>
    <div class="other">
      <input type="text" class="input yzm">
      <div class="yzm-pic"><img src="images2/upload/yzm-02.jpg"></div>
      <a href="#" class="btn">换一张</a>
    </div>
      <div class="error-info">填写报错信息</div>
  </div>
  <div class="each-input1">
   <button class="send-btn">发送验证邮件</button>
   <!---点击按钮之后 增加class finish---->
   <div class="s-info">一封邮件已经发送到您的指定邮箱，如未收到，<i>59</i>秒后请再次点击发送验证邮件</div>
  </div>
</div>
