		...
		<div class="main-right">
			<div class="right-top">
				<div class="per-top w740">
					<a href="#" class="per-span cur-per"><img src="/Public/Home/images/icon/evaluate01.png" alt="">收到的评价</a>
					<a href="#" class="per-span"><img src="/Public/Home/images/icon/evaluate02.png" alt="">发出的评价</a>
					...
					<ul>
						<li>
							<div class="eva-inner clearfix">
								<div class="eva-left">
									<div class="eva-pic">
										<img src="/Public/Home/images/friend01.png" alt="">
									</div>
								</div>
								<div class="eva-right">
