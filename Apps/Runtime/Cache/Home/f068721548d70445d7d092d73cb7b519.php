		...
		<div class="main-right">
			<div class="right-top">
				<div class="top-inner w740">
					<p class="top-text"><img src="/Public/Home/images/icon/personal04.png" alt="">您已经撰写了 <span class="orange">10</span> 份笔记<a href="<?php echo U('Book/makeNotes');?>" class="white-note">写新的笔记</a></p>
			...
			<div class="right-inner result-inner w740">
				...
				<div class="search-result">
					<ul>
						<li class="clearfix">
							<span class="pic01"><img src="/Public/Home/images/icon/personal03.png" alt=""></span>
							<div class="note-info">
