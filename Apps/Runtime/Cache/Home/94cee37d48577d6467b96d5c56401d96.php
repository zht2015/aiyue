 ...
 <div class="hd-bottom">
  ...
  <div class="main gap">
    ...
    <div class="booklist-two">
      <ul class="list">
      <?php if(is_array($book)): foreach($book as $key=>$vo): ?><li class="selected-blue">
          <div class="item-main">
            <div class="pic-wrap">
              <div class="pic-box"><img src="<?php echo ($vo["book_cover"]); ?>" >
                <div class="mask">
                  <p><a href="/index.php/Home/Book/tsDetail/id/<?php echo ($vo["id"]); ?>.html">图书详情</a>/<a href="#">加入书单</a></p>
                </div>
              </div>
            </div>
            <h3 class="title"><?php echo ($vo["book_name"]); ?></h3>
          ...
          <div class="item-main">
            <div class="pic-wrap">
              <div class="pic-box"><img src="/Public/Home/images2/upload/s-ts-1.jpg">
                <div class="mask">
                  <p><a href="<?php echo U('Book/tsDetail');?>">图书详情</a>/<a href="#">加入书单</a></p>
                </div>
              </div>
            </div>
