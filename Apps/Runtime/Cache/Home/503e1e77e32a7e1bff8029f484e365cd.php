		...
		<div class="main-right">
			<div class="right-top">
				<div class="per-top w740">
					<a href="<?php echo U('Users/myFollow');?>" class="per-span cur-per">@我关注的</a>
					<a href="<?php echo U('Users/followMe');?>" class="per-span">@关注我的</a>
			...
			<div class="right-inner w740">
				<div class="friend-top">我关注的全部好友：<span class="orange">145人</span></div>
