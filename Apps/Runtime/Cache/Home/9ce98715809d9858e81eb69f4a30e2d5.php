...
<div class="main">
    <div class="jifengm">
        <div class="jgm-jindu"><img src="/Public/Home/images/jfjd1.jpg"/></div>
        <div class="shdz">
        ...
        <div class="qrdan">
            ...
            <div class="qrdan-2">
                ...
                <ul>
                    <li>
                        <div class="w13">
                            <a class="ddtu" href="<?php echo U('Goods/goodDetails',array('id'=>$info[0]['id']));?>"><img src="<?php echo ($info[0]['img_url']); ?>" width="98" height="99" /></a>
                        </div>
                        <div class="w30 "><span><a href="<?php echo U('Goods/goodDetails',array('id'=>$info[0]['id']));?>"><?php echo ($info[0]['title']); ?></a></span></div>
                        <div class="w14 tc pt42">￥<?php echo ($info[0]['sell_price']); ?></div>
                        <div class="w14 tc pt42" style="width:20.5%;"><?php echo ($number); ?></div>
                        <div class="w15 tc pt42" style="width:20.5%;">￥<?php echo ($totalMoney); ?></div>
                    </li>
                </ul>
            </div>
            <div class="qrdan-3">
                <div class="qfukb" style="height:auto;">
                    <div class="syojf">
                        ...
                        <p>（可用<?php echo ($userInfo['point']); ?>点）</p>
                    </div>
                    <div class="jftjdd">
...
<input type="hidden" id="goodsId" value="<?php echo ($info[0]['id']); ?>"/>   <!--商品ID-->
<input type="hidden" id="link_url" value="<?php echo ($info[0]['img_url']); ?>"/>   <!--商品图片-->
<input type="hidden" id="title" class='mytitle' value="<?php echo ($info[0]['title']); ?>"/>   <!--商品名称-->
<input type="hidden" id="goodsPrice" value="<?php echo ($info[0]['sell_price']); ?>"/>   <!--商品单价-->
<input type="hidden" id="goodsTotalPrice" value="<?php echo ($totalMoney); ?>"/>   <!--商品总价-->
<input type="hidden" id="number" value="<?php echo ($number); ?>"/>   <!--商品数量-->
...
<script>
    ...
    function toPay(){
        ...
        params.linkUrl  =  $("#link_url").val();
        params.title  =  $(".mytitle").val();
        params.goodsPrice  =  $("#goodsPrice").val();
        params.goodsTotalPrice  =  $("#goodsTotalPrice").val();
        params.buyerMessage = $("#buyerMessage").val();
