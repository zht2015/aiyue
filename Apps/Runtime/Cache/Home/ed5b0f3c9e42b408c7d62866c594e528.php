		...
		<div class="main-right">
			<div class="right-top">
				<div class="per-top w850">
					<a href="<?php echo U('Collect/collectSd');?>" class="per-span">收藏的书单</a>
					<a href="<?php echo U('Collect/collectBook');?>" class="per-span cur-per">收藏的图书</a>
