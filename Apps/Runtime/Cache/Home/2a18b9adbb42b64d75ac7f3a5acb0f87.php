...
<?php elseif($user["user_type"] == 1): ?>
		...
		<div class="main-right">
			<div class="right-top">
				<div class="top-inner w740">
					<p class="top-text"><img src="/Public/Home/images/icon/personal06.png" alt="">您已制作了 <span class="orange">10</span> 份书单<a href="#" class="white-note" id="make-new-booklist">制作新的书单</a><a href="#" class="white-note" id="one-click-upload">一键上传表格</a></p>
				...
				<div class="search-result sd">
					<ul>
						<?php if(is_array($bookListInfo)): foreach($bookListInfo as $key=>$vo): ?><li class="clearfix">
							...
							<div class="note-info">
								<a href="#">书单名称：《<?php echo ($vo["booklist_name"]); ?>》</a>
	...
	<div class="pop book01-pop">
		<div class="book01-inner">
			...
			<div class="book01-file clearfix">
				...
				<span class="book01-span"><div id="filePicker2">&nbsp;&nbsp;</div></span>
			</div>
	...
	<div class="mask"></div>
	<div class="pop yjsc">
		<h5><img src="/Public/Home/images/icon/yjsc01.png" alt="">一键上传书单</h5>
		<div class="yjsc-input">
			<input type="text" placeholder="上传格式为EXCEL" id="excel-path">
			<span class="file-excel" id="filePicker"><!-- <input type="file"> --></span>
			
		</div>
		<a href="javascript:void(0);" class="wcsc" onclick="upload();">完成上传</a>
		<a href="/Public/booklist.xls" class="down-mb"><img src="/Public/Home/images/icon/yjsc02.png" alt="">请先下载模板</a>
	...
	<script>
		...
		$("#one-click-upload").click(function(){
			$(".mask").show();
			$('.yjsc').show();
		});
        ...
        function makeBookList(){
            ...
            $.post("<?php echo U('Home/Book/makeBookList');?>",{"booklist_name":booklist_name,"booklist_cover":booklist_cover,"booklist_discription":booklist_discription,"recomend":recomend,"booklist_tag":tag},function(data) {
            	...
            	if(data.status==1){
            		...
            		location.href="<?php echo U('Home/Book/press_booklist');?>";
		...
		function upload(){
			...
			$.post("<?php echo U('Book/importBooklist');?>", {"file":file,"flag":0}, function(data){
				console.log("cg");
			})
		}
	</script>
