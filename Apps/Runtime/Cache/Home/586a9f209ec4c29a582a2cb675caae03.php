    ...
    <div class="blist-details-left">
      <div class="details-03 clearfix">
        <div class="ts-pic selected-blue selected-orange">
          <div class="ts-pic-inner"><img src="<?php echo ($bookinfo["book_cover"]); ?>"></div>
        </div>
        <div class="ts-other">
          <h2 class="title"><?php echo ($bookinfo["book_name"]); ?></h2>
          ...
          <div class="info-01"><span>站内推荐：</span><?php echo ($bookinfo["book_name"]); ?></div>
          ...
          <div class="info-03"><span>作者：<?php echo ($bookinfo["book_author"]); ?></span><span>出版社：<?php echo ($bookinfo["book_press"]); ?></span><span>ISN编号：<?php echo ($bookinfo["isbn"]); ?></span></div>
          <div class="info-03"><span>图书编号：025687</span><span>出版时间：<?php echo ($bookinfo["book_publication_time"]); ?></span></div>
      ...
      <div class="details-02">
        <div class="content-introduce">
          ...
          <div class="list-sort-02">
            <h3>内容介绍：</h3>
           <?php echo ($bookinfo["content_intro"]); ?>
          </div>
        </div>
          <!--内容介绍-->
        <div class="author-introduce">
          <div class="list-sort-01">
              <?php echo ($bookinfo["author_intro"]); ?>
          </div>
        </div>
        <!--作者介绍-->
