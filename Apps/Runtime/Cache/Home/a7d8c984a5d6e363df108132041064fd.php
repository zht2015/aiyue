...
<div class="header">
 ...
 <div class="hd-bottom">
  ...
  <div class="main">
    <div class="study">
      <h5 class="source-head">[ 我们的研究 ]</h5>
      <div class="study-inner clearfix">
        <div class="study-left">
          <ul>
            <li class="clearfix">
              <img src="images2/upload/study01.jpg" alt="">
              <div class="study-text">
                <a href="#" class="study-text-title">在世界读书日，跟着大师...</a>
                <span class="study-text-date">2012.06.04</span>
                <p class="study-p">在悠久的历史长河中，我们的先人留下了浩如烟海般的书籍，这其中蕴含了众多的大智慧，就让我们在学术大家的带领下，遨游于历史之中，去进一步深入领略国学的魅力。本期主题推荐书单即以“......慧——名家讲国学”为主题...让我们在学术大家的带领下，遨游于历史之中，去进一步深入领略国学的魅力。</p>
                <a href="#" class="read-more">READ MORE<i></i></a>
              </div>
            </li>
            <li class="clearfix">
              <img src="images2/upload/study01.jpg" alt="">
        ...
        <div class="study-right">
          <ul>
            <li><a href="#"><img src="images2/upload/study02.jpg" alt=""></a></li>
            <li><a href="#"><img src="images2/upload/study02.jpg" alt=""></a></li>
            <li><a href="#"><img src="images2/upload/study02.jpg" alt=""></a></li>
            <li><a href="#"><img src="images2/upload/study02.jpg" alt=""></a></li>
            <li><a href="#"><img src="images2/upload/study02.jpg" alt=""></a></li>
...
<div class="footer">
  <div class="footer-main">
    <p class="f-nav"><a href="#">首页</a>|<a href="#"> 关于我们 </a>|<a href="#">图书</a>|<a href="#">研究 </a>| <a href="#">新闻BLOG</a>| <a href="#">论坛/奖项 </a>| <a href="#">资源库</a> </p>
    <p class="other"><span>Copyright ©2015 iread All Rights Reserved</span> <span>designed by : <a href="#">momu</a></span></p>
  </div>
</div>
</body>
</html>
