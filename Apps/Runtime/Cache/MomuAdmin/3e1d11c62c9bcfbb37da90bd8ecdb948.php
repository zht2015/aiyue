...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //初始化上传控年
        $(".upload-attach").InitUploader({ filesize: "102400", sendurl: "<?php echo U('UploadJson/uploadFileF');?>", swf: "/Public/Admin/scripts/webuploader/uploader.swf", filetypes: "gif,jpg,png,bmp,rar,zip,doc,xls,txt,mov" });
        //远程或者本地上传
    ...
    function execAttachHtml() {
        ...
        if ($("input[name='attachType']:checked").val() == 0) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo U('UploadJson/dialog_info');?>",
                data: {
...
<body>
<form method="post" action="dialog_attach.aspx" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEzMDg2OTU4MzBkZOFcmVTYnMSDeBae5t5vObFrLv2ZtEhZU/+JNPAMmSWg" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="DE13642E" />
</div>
