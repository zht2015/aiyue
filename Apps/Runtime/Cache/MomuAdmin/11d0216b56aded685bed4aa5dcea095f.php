...
<body class="mainbody">
<form method="post" action="/index.php/MomuAdmin/Article/category_insert/channel_id/<?php echo ($channelid); ?>" id="form1">
<div>
...
<!--导航栏-->
<div class="location">
  <a href="/index.php/MomuAdmin/Article/category_list/channel_id/<?php echo ($channelid); ?>" class="back"><i></i><span>返回列表页</span></a>
  <a href="" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="/index.php/MomuAdmin/Article/category_list/channel_id/<?php echo ($channelid); ?>"><span>内容类别</span></a>
  <i class="arrow"></i>
  <span>新增分类</span>
</div>
  ...
  <?php if($channelid == '7'): ?><dl>
	  ...
	  <dl>
	       ...
	       <dd>
	           ...
	           <span>&emsp;(是否推荐决定是否在首页中展示 允许4个)</span>
	       </dd>
	  </dl><?php endif; ?>
