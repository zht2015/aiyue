...
<body class="mainbody">
<form method="get" action="/index.php/MomuAdmin/Advertise/article_list/channel_id/<?php echo ($channelid); ?>/viewtype/viewtxt" id="form2">
...
<form method="post" action="/index.php/MomuAdmin/Advertise/article_list/channel_id/<?php echo ($channelid); ?>/viewtype/viewtxt" id="form1">
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/index.php/MomuAdmin/Advertise/article_add/channel_id/<?php echo ($channelid); ?>/viewtype/viewtxt"><i></i><span>新增</span></a></li>
...
<select name="ddlCategoryId" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ddlCategoryId\&#39;,\&#39;\&#39;)&#39;, 0)" id="ddlCategoryId">
	...
	<?php if(is_array($categorys)): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php if(($vo['id']) == $_REQUEST['ddlCategoryId']): ?>selected<?php endif; ?> ><?php echo ($vo['befor']); echo ($vo['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
      ...
      <div class="r-list">
        <input name="txtKeywords" value="<?php echo ($_REQUEST['txtKeywords']); ?>" placeholder="<?php echo ($searchstr); ?>" type="text" id="txtKeywords" class="keyword" />
    ...
    <ul>
    	<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li>
		        <div class="details">
		          ...
		          <?php if($vo['img_url'] == ''): ?><div class="pic"><a href="/index.php/MomuAdmin/Advertise/article_edit/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>/viewtype/viewtxt"><img src="/Public/Admin/skin/default/loadimg.gif" data-original="<?php echo ($vo['img_url']); ?>" /></a></div><i class="absbg"></i> 
		          <?php else: ?>
			          <div class="pic"><a href="/index.php/MomuAdmin/Advertise/article_edit/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>/viewtype/viewtxt"><img src="<?php echo ($vo['img_url']); ?>" data-original="<?php echo ($vo['img_url']); ?>" /></a></div><i class="absbg"></i><?php endif; ?>
		          <h1><span><a href="/index.php/MomuAdmin/Advertise/article_edit/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>/viewtype/viewtxt"><?php echo ($vo['title']); ?></a></span></h1>
		          <!-- <div class="remark">
		          ...
		          <div class="foot">
		            ...
		            <a href="/index.php/MomuAdmin/Advertise/article_edit/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>/viewtype/viewtxt" title="编辑" class="edit">编辑</a>
		          </div>
		        </div>
