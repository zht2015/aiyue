...
<body class="mainbody">
<form method="post" action="/index.php/MomuAdmin/Market/article_insert/channel_id/<?php echo ($channelid); ?>" id="form1">
<input type="hidden" name="viewtype" value="<?php echo ($viewtype); ?>" />
<!--导航栏-->
<div class="location">
  <a href="/index.php/MomuAdmin/Market/article_list/channel_id/16" class="back"><i></i><span>返回列表页</span></a>
  <a href="" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="/index.php/MomuAdmin/Market/article_list/channel_id/16"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>新增内容</span>
</div>
