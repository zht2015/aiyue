...
<form method="post" action="<?php echo U('Field/field_add');?>" id="form1">
    ...
    <div class="tab-content">
        ...
        <dl id="dlDataLength" class="single-text-tr multi-text-tr multi-radio-tr multi-checkbox-tr" style="display:none;">
            <dt>字符串长度</dt>
            <dd><input name="txtDataLength" type="text" id="txtDataLength" class="input small" datatype="n" sucmsg=" " /> <span class="Validform_checktip">*数字，默认50个字符</span></dd>
        </dl>
...
<script>
    ...
    function getPostData(){
        ...
        if(type=="single-text"){
            ...
            var datatype = "text";
            postData = {"control_type":type,"sort_id":$("#txtSortId").val(),"data_type":datatype,"name":$("#txtName").val(),"title":$("#txtTitle").val(),"is_required":isrequired ,"editor_type":edittype,"default_value":$("#txtDefaultValue").val(),"valid_pattern":$("#txtValidPattern").val(),"valid_tip_msg":$("#txtValidTipMsg").val(),"valid_error_msg":$("#txtValidErrorMsg").val()};
            
        }else if(type=="images"){
            var isrequired = $("#cbIsRequired").prev("a").attr("class") == "selected"?1:0;
            var datatype = "text";
            postData = {"control_type":type,"sort_id":$("#txtSortId").val(),"data_type":datatype,"name":$("#txtName").val(),"title":$("#txtTitle").val(),"is_required":isrequired ,"default_value":$("#txtDefaultValue").val(),"valid_pattern":$("#txtValidPattern").val(),"valid_tip_msg":$("#txtValidTipMsg").val(),"valid_error_msg":$("#txtValidErrorMsg").val()};
            ...
            postData = {"control_type":type,"sort_id":$("#txtSortId").val(),"data_type":datatype,"name":$("#txtName").val(),"title":$("#txtTitle").val(),"is_required":isrequired ,"default_value":$("#txtDefaultValue").val(),"valid_tip_msg":$("#txtValidTipMsg").val()};
             ...
             postData = {"control_type":type,"sort_id":$("#txtSortId").val(),"data_type":datatype,"name":$("#txtName").val(),"title":$("#txtTitle").val(),"is_required":isrequired ,"default_value":$("#txtDefaultValue").val(),"item_option":itemoption,"valid_tip_msg":$("#txtValidTipMsg").val()};
             
        }else if(type=="multi-checkbox"){
        	 var isrequired = $("#cbIsRequired").prev("a").attr("class") == "selected"?1:0;
             var datatype = "varchar("+$("#txtDataLength").val()+")";
             var itemoption = $("#txtItemOption").val();
             postData = {"control_type":type,"sort_id":$("#txtSortId").val(),"data_type":datatype,"name":$("#txtName").val(),"title":$("#txtTitle").val(),"is_required":isrequired ,"default_value":$("#txtDefaultValue").val(),"data_length":$("#txtDataLength").val(),"item_option":itemoption,"valid_tip_msg":$("#txtValidTipMsg").val()};
