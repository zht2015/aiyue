...
<body class="mainbody">
<form method="get" action="/Index.php/MomuAdmin/Advertise/article_list/channel_id/<?php echo ($channelid); ?>" id="form2">
...
<form method="post" action="/Index.php/MomuAdmin/Advertise/article_list/channel_id/<?php echo ($channelid); ?>" id="form1">
<div>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/Index.php/MomuAdmin/Advertise/article_add/channel_id/<?php echo ($channelid); ?>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    ...
    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
	      ...
	      <td align="center">
	        <a href="/Index.php/MomuAdmin/Advertise/article_edit/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>">修改</a>
	      </td>
