...
<body class="mainbody">
<form method="post" action="/index.php/MomuAdmin/Users/group_edit/id/<?php echo ($edata['id']); ?>" id="form1">
<!--导航栏-->
<div class="location">
...
<div class="tab-content">
  <dl>
    <dt>组别名称：</dt>
    <dd>
      <input name="txtTitle" value="<?php echo ($edata['title']); ?>" type="text" maxlength="100" id="txtTitle" class="input normal" datatype="*1-100" sucmsg=" " minlength="2" />
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
        <input id="rblIsLock" <?php if(($edata['is_lock']) == "1"): ?>checked<?php endif; ?> type="checkbox" name="rblIsLock" />
      </div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
        <input id="rblIsDefault" <?php if(($edata['is_default']) == "1"): ?>checked<?php endif; ?> type="checkbox" name="rblIsDefault" />
      </div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
        <input id="rblIsUpgrade" <?php if(($edata['is_upgrade']) == "1"): ?>checked<?php endif; ?> type="checkbox" name="rblIsUpgrade" />
      </div>
  ...
  <dl>
    <dt>等级值：</dt>
    <dd>
      <input name="txtGrade" value="<?php echo ($edata['grade']); ?>" type="text" id="txtGrade" class="input small" datatype="n" sucmsg=" " />
  ...
  <dl>
    <dt>升级所需积分：</dt>
    <dd>
      <input name="txtUpgradeExp" value="<?php echo ($edata['upgrade_exp']); ?>" type="text" id="txtUpgradeExp" class="input small" datatype="/^-?\d+$/" sucmsg=" " />
  ...
  <dl>
    <dt>初始金额：</dt>
    <dd>
      <input name="txtAmount" type="text" value="<?php echo ($edata['amount']); ?>" id="txtAmount" class="input small" datatype="/^-?(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" " />
  ...
  <dl>
    <dt>初始积分：</dt>
    <dd>
      <input name="txtPoint" type="text" value="<?php echo ($edata['point']); ?>" id="txtPoint" class="input small" datatype="/^-?\d+$/" sucmsg=" " />
  ...
  <dl>
    <dt>购物折扣：</dt>
    <dd>
      <input name="txtDiscount" type="text" value="<?php echo ($edata['discount']); ?>" id="txtDiscount" class="input small" datatype="n" sucmsg=" " />
