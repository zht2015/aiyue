...
<body class="mainbody">
<form method="get" action="/index.php/MomuAdmin/Users/mail_template_list" id="form2">
	<input type="hidden" id="txtKeywords" name="txtKeywords" value="<?php echo ($_REQUEST['txtKeywords']); ?>" />
	<input type="hidden" id="p" name="p" value="" />
</form>

<form method="post" action="/index.php/MomuAdmin/Users/mail_template_list" id="form1">
<div>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/index.php/MomuAdmin/Users/mail_template_add"><i></i><span>新增</span></a></li>
  ...
  <?php if(empty($list)): ?><tr><td align="center" colspan="5">暂无记录</td></tr>
	<?php else: ?>
		<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
		    ...
		    <td><a href="/index.php/MomuAdmin/Users/mail_template_edit/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></a></td>
		    <td align="center">
		    	<?php if($vo['is_sys'] == '1'): ?>√
		    	<?php else: ?>
		    	X<?php endif; ?>
		    </td>
		    <td align="center"><a href="/index.php/MomuAdmin/Users/mail_template_edit/id/<?php echo ($vo['id']); ?>">修改</a></td>
