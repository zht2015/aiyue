...
<body class="mainbody">
<form method="get" action="/index.php/MomuAdmin/Users/recharge_list" id="form2">
	<input type="hidden" id="txtKeywords" name="txtKeywords" value="<?php echo ($_REQUEST['txtKeywords']); ?>" />
	<input type="hidden" id="p" name="p" value="" />
</form>


<form method="post" action="/index.php/MomuAdmin/Users/recharge_list" id="form1">
<div>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/index.php/MomuAdmin/Users/recharge_add"><i></i><span>充值</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="center" width="18%">状态</th>
	...
	<?php else: ?>
		<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
		    ...
		    <td><?php echo ($vo['recharge_no']); ?></td>
		    <td><?php echo (getPaymentName($vo['payment_id'])); ?></td>
		    <td align="center"><?php echo ($vo['amount']); ?></td>
		    <td align="center">
		    	<?php if($vo['status'] == '1'): ?>已完成(<?php echo ($vo['complete_time']); ?>)
		    	<?php else: ?>
		    	未完成<?php endif; ?>
		    </td>
