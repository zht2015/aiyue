...
<body class="mainbody">
<form method="post" action="/Index.php/MomuAdmin/Advertise/category_list/channel_id/<?php echo ($channelid); ?>" id="form1">
<div >
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/Index.php/MomuAdmin/Advertise/category_add/channel_id/<?php echo ($channelid); ?>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    ...
    <?php if(is_array($categorylist)): $k = 0; $__LIST__ = $categorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="<?php echo ($vo['id']); ?>" pid="<?php echo ($vo['parent_id']); ?>">
			  ...
			  <td>
			  	<?php echo ($vo['befor']); ?>
			  	<a href="/Index.php/MomuAdmin/Advertise/category_edit/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></a>
			  </td>
			  <td>
		      ...
		      <td align="center">
			    <a href="/Index.php/MomuAdmin/Advertise/category_edit/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>">修改</a>&nbsp;
			    <?php if($vo['parent_id'] == '0'): ?><a href="/Index.php/MomuAdmin/Advertise/category_add/channel_id/<?php echo ($channelid); ?>/id/<?php echo ($vo['id']); ?>">添加子类</a>
			        <?php else: ?>
