...
<body class="mainbody">
<form method="post" action="/index.php/MomuAdmin/Market/category_save/channel_id/<?php echo ($channelid); ?>" id="form1">
<div>
...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        <span id="isselect">
        	<input id="isselect_0" type="radio" name="isselect" value="2" <?php if(($edata['is_select']) == "2"): ?>checked="checked"<?php endif; ?> />
        	<label for="isselect_0">是</label>
        	<input id="isselect_1" type="radio" name="isselect" value="1" <?php if(($edata['is_select']) == "1"): ?>checked="checked"<?php endif; ?> />
