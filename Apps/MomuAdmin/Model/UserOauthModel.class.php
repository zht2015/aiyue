...
class UserOauthModel extends CommonModel{
    
    /***
     * @time 2016/06/02
     * @biking
     * @function 获取user_oauth表的列表数据
    ...
    public function getTabList($coum="",$order="id asc",$where="",$Page="",$type=""){
        return $this->getList("user_oauth",$coum,$order,$where,$Page,$type);  
    }
    ...
    public function delDataById($ids){
        return $this->deleteDataById("user_oauth", $ids);
    }
