...
class MarketValueModel extends CommonModel{
    ...
    public function getTabList($coum="",$order="id asc",$where="",$Page="",$type=""){
        return $this->getList("market_value",$coum,$order,$where,$Page,$type);
    }
    ...
    public function articleDataInsert($channelid){
        $tab = M("market_value");
        $tab1 = M("market_albums");
        $tab2 = M("market_attach");
        $tab4 = M("channel_field");
        $tab5 = M("article_attribute_field");
        $tab6 = M("market_cat_relation");
